...
#include "Wesley_S_FinalCharacter.generated.h"

class UInputComponent;

UCLASS(config=Game)
class AWesley_S_FinalCharacter : public ACharacter
{
	GENERATED_BODY()
...
public:
	...
	TSubclassOf<class AWesley_S_FinalProjectile> ProjectileClass;
